...
function Input(props) {
	const {value= "", placeholder = "", type = "text", handlerChange = () => {}, addCSS = {
			input: "",
		}, } = props;
	...
	return (
		<input
			...
			className={twMerge(`rounded-lg border-1 border-slate-400 pl-10 p-2.5 w-full dark:bg-gray-700 dark:text-blue ${addCSS.input}`)}
		/>
	);
}
...
function InputDatepicker(props){
	const {value="", handlerChange = () => {}, addCSS = {
			input: "",
		},} = props;
