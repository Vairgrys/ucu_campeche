				...
				<div className='flex ml-2 items-center w-full'>
					...
					<div className='flex w-full'>
							<div className="w-full">
								...
								<Input.datepicker value={fechaTermino} setBirthday={setFechaTermino}></Input.datepicker>
								<hr className='mt-6 w-1/2' />
								<h4 className="pt-2 col-span-3 text-sm text-slate-400 mb-5">Año/Mes/Día</h4>
							</div>
							<div className="pl-2">
